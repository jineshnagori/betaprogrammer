...
$(".utf-resources-filter-item").each(function() {
    var e = $(this);
	var $grid = e.isotope({
        layoutMode: "masonry",
    });
	$(".utf-resources-filter-menu").find("a").on("click", function() {
        var filterValue = $(this).attr("data-filter");
        return $(".utf-resources-filter-menu").find("a").removeClass("active"), $(this).addClass("active"), 
		$grid.isotope({
          filter: filterValue
        }), !1
    });
